...
(defn format-command
  [command]
  {:direction-letter  (subs command 0 1)
...
(defn closest-intersection
  [wire1 wire2]
  (apply min (map manhattan-distance (list-intersections wire1 wire2))))
